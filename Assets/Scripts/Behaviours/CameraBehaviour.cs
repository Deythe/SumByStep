...
public class CameraBehaviour : MonoBehaviour
{
    ...
    {
        _targetPosition = _cameraTransform.position + (-dir_.x * _cameraTransform.right + -dir_.y * _cameraTransform.up) * Time.deltaTime * _speedManual;
        _targetPosition.y = _cameraTransform.position.y;
